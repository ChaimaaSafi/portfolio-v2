...
const BlogItem = ({
  ...
  return (
    <div className="w-full  transition duration-300 hover:scale-95 hover:brightness-90 rounded-md">
      <Link
        href={`blog/${link}`}
        target="_blank"
        ...
        ${
          style === "full"
            ? "md:flex-row justify-between space-x-3 items-center flex-col md:pb-0 pb-5"
            : "flex-col pb-5 "
        }
        `}
      >
